...
public class CustomAnswerAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View itemView = inflater.inflate(R.layout.quiz_gridview_item, parent, false);
		
		TextView nameTxt = (TextView) itemView.findViewById(R.id.textview_gridview_customitem);
