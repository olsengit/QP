...
/*
 * Adapter for the category listview
 */
public class CustomCategoryAdapter extends ArrayAdapter<Category> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.category_listview_row, parent,
				false);

		ImageView picture = (ImageView) rowView
				.findViewById(R.id.imageview_customcategory_image);
		TextView category = (TextView) rowView
				.findViewById(R.id.textview_customcategory_name);
